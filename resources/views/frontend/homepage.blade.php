          ...
          <div class="owl-carousel owl-theme home_slider">
            ...
            <div class="owl-item">
              ...
              <div class="home_slider_content">
                ...
                <!-- <div class="home_slider_subtitle">Fira's Home Care Babu
            ...
            <div class="owl-item">
              <div
                class="home_slider_background"
                style="background-image: url({{ asset('frontend/images/Baby.png') }})"
              ></div>
              <div class="home_slider_content">
                <div class="home_slider_content_inner">
                  <!-- <div class="home_slider_subtitle">Fira's Baby Care Day</div> 
                  <div class="home_slider_title">Dapatkan Sekarang</div>  -->
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col">
              <div class="section_title_container text-center">
                ...
                <div class="section_title">Layanan Kami</div>
              </div>
            </div>
          </div>
