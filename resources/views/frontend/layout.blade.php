  ...
  <body>
    <div class="super_container">
      ...
      <header class="header">
        ...
        >
          <div class="logo"><a href="{{ route('homepage') }}">Fira's Baby Care</a></div>
          <nav class="main_nav">
            <ul>
      ...
      >
        ...
        <div class="logo menu_mm"><a href="{{ route('homepage') }}">FIRAS CARE</a></div>
        <nav class="menu_nav">
          <ul class="menu_mm">
            <li><a href="{{ route('homepage') }}">home</a></li>
        ...
        <div class="container">
          <div class="row">
            <div class="col text-center">
              <div class="footer_logo"><a href="{{ route('homepage') }}">Fira's Baby Care</a></div>
              ...
              <div class="copyright">
                ...
                All rights reserved | Firas Baby Care
              </div>
            </div>
          </div>
        </div>
